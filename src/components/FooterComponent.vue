  ...
  <div class="footer">
    <div class="footer__container">
      ...
      <div class="footer__col-text">
        <div class="footer__col-text-item">About Us</div>
        <div class="footer__col-text-item">Contact</div>
        <div class="footer__col-text-item">Blog</div>
      </div>
      <div class="footer__col-text">
        <div class="footer__col-text-item">Careers</div>
        <div class="footer__col-text-item">Support</div>
        <div class="footer__col-text-item">Privacy Policy</div>
      </div>
